(function(exports) {
    ...
    var Player = new Class({
        initialize: function(bufferManager, seq) {
            ...
            this._drawOperations.push(new Base.FullFrameDrawOperation("Draw Video", 0, 0, Base.BUFFER_WIDTH, Base.BUFFER_HEIGHT, function(cb) {
        ...
        _makeFakeUI: function() {
            ...
            this._drawOperations.push(new Base.FullFrameDrawOperation("Draw Seek Bar", x, seekY, seekW, seekH, function(cb) {
                // Seek bar
